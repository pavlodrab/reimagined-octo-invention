...
var TRANSLATIONS = {
    ru: {
        ...
        settings: {
            ...
            background_pick: 'Выбрать фото',
            background_clear: 'Сбросить',
            background_empty: 'Фон не выбран',
            background_invalid: 'Это не картинка',
            background_too_large: 'Картинка слишком большая, выбери поменьше',
            background_local_hint: 'Сохраняется только на этом устройстве. Картинку никуда не отправляем.',
            save: 'Сохранить фон',
            info: 'Информация',
        ...
        admin: {
            ...
            config: {
                ...
                font_sport: 'Sport — Inter + Russo One',
                font_classic: 'Classic — Roboto + Oswald',
                font_modern: 'Modern — Manrope',
                font_hint: 'Меняется у всех пользователей.',
    ...
    en: {
        ...
        settings: {
            ...
            background_pick: 'Pick a photo',
            background_clear: 'Clear',
            background_empty: 'No background set',
            background_invalid: 'That is not an image',
            background_too_large: 'Image is too large, pick a smaller one',
            background_local_hint: 'Stored on this device only. The picture is not uploaded anywhere.',
        ...
        admin: {
            ...
            config: {
                ...
                font_classic: 'Classic — Roboto + Oswald',
                font_modern: 'Modern — Manrope',
                font_hint: 'Changes for every user.',
